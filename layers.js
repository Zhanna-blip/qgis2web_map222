...
var format_lab1lab_1_6 = new ol.format.GeoJSON();
var features_lab1lab_1_6 = format_lab1lab_1_6.readFeatures(json_lab1lab_1_6, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_lab1lab_1_6 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_lab1lab_1_6.addFeatures(features_lab1lab_1_6);
var lyr_lab1lab_1_6 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_lab1lab_1_6, 
                style: style_lab1lab_1_6,
                popuplayertitle: 'lab1 — lab_1',
                interactive: true,
                title: '<img src="styles/legend/lab1lab_1_6.png" /> lab1 — lab_1'
            });

lyr_OSMStandard_0.setVisible(true);lyr_lab1_1.setVisible(true);lyr_building_house_2.setVisible(true);lyr_building_3.setVisible(true);lyr_highway_4.setVisible(true);lyr_highway_5.setVisible(true);lyr_lab1lab_1_6.setVisible(true);
var layersList = [lyr_OSMStandard_0,lyr_lab1_1,lyr_building_house_2,lyr_building_3,lyr_highway_4,lyr_highway_5,lyr_lab1lab_1_6];
lyr_lab1_1.set('fieldAliases', {'name': 'name', });
lyr_building_house_2.set('fieldAliases', {'full_id': 'full_id', 'osm_id': 'osm_id', 'osm_type': 'osm_type', 'wheelchair': 'wheelchair', 'level': 'level', 'entrance': 'entrance', 'door': 'door', 'access': 'access', });
...
lyr_lab1lab_1_6.set('fieldAliases', {'fid': 'fid', 'name': 'name', });
lyr_lab1_1.set('fieldImages', {'name': 'TextEdit', });
lyr_building_house_2.set('fieldImages', {'full_id': '', 'osm_id': '', 'osm_type': '', 'wheelchair': '', 'level': '', 'entrance': '', 'door': '', 'access': '', });
...
lyr_highway_4.set('fieldImages', {'fid': '', 'full_id': '', 'osm_id': '', 'osm_type': '', 'highway': '', 'direction': '', 'locked': '', 'motor_vehicle': '', 'bicycle': '', 'tactile_paving': '', 'shelter': '', 'bench': '', 'motorcycle': '', 'motorcar': '', 'hgv': '', 'goods': '', 'foot': '', 'name': '', 'memorial': '', 'historic': '', 'crossing': '', 'access': '', 'barrier': '', 'traffic_calming': '', 'railway': '', });
